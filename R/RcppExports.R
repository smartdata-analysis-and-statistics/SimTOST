...
count_power_cpp <- function(n_per_arm, rate_test, rate_reference, exposure_test, exposure_reference, margin_lower, margin_upper, model, dispersion_test, dispersion_reference, alpha, nsim, design, sigmaB, Eper, Eco, dropout) {
    .Call(`_SimTOST_count_power_cpp`, n_per_arm, rate_test, rate_reference, exposure_test, exposure_reference, margin_lower, margin_upper, model, dispersion_test, dispersion_reference, alpha, nsim, design, sigmaB, Eper, Eco, dropout)
}

count_power_multi_cpp <- function(n_per_arm, rate_test, rate_reference, exposure_test, exposure_reference, margin_lower, margin_upper, model, dispersion_test, dispersion_reference, alpha, nsim, design, endpoint_corr, typey, adseq, k, sigmaB, Eper, Eco, dropout) {
    .Call(`_SimTOST_count_power_multi_cpp`, n_per_arm, rate_test, rate_reference, exposure_test, exposure_reference, margin_lower, margin_upper, model, dispersion_test, dispersion_reference, alpha, nsim, design, endpoint_corr, typey, adseq, k, sigmaB, Eper, Eco, dropout)
}

count_power_joint_cpp <- function(n_per_arm, rates, exposure, margin_lower, margin_upper, model, dispersion, alpha, endpoint_corr, comparisons, typey, adseq, k, nsim) {
    .Call(`_SimTOST_count_power_joint_cpp`, n_per_arm, rates, exposure, margin_lower, margin_upper, model, dispersion, alpha, endpoint_corr, comparisons, typey, adseq, k, nsim)
}
