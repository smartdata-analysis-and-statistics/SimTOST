...
#' @description Constructs and returns a list of key parameters (mean vectors, variance-covariance matrices, and allocation rates) required for input into the `calopt` function. This function ensures that the parameters for each endpoint and comparator are consistent, properly named, and formatted.
#'
