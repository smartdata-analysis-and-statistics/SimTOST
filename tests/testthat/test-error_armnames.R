# #context("Error arm names")
# test_that("Returns error incorrect arm names", {
#   local_edition(3)
#   mu_T <- c(37162.0, 35702.0, 125.9)
...
#                                     ncores=1),"Names included in the list_comparator should be coherent with the names in the arm_names vector")
#
# })
