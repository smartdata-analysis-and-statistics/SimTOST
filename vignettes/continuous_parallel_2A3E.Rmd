...
# The comparison, margins, and simulation settings are unchanged. Update the
# result with the endpoint-specific means and standard deviations only.
(sim_AUClast <- update(
  sim_AUCinf,
  mu_list = list("SB2" = 36862, "EU_Remicade" = 37022),
  sigma_list = list("SB2" = 9133, "EU_Remicade" = 9398)
))

(sim_Cmax <- update(
  sim_AUClast,
  mu_list = list("SB2" = 127.0, "EU_Remicade" = 126.2),
  sigma_list = list("SB2" = 16.9, "EU_Remicade" = 17.9)
))
```
