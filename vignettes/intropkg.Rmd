...
The `t` adjustment described below is the strong k-out-of-m procedure for
...
the Type I error rate for the partial-conjunction decision, including cases in
which only some endpoints satisfy the null hypothesis [@mielke_sample_2018].
