...
be specified with `cor_mat`; for count outcomes this is a latent
Gaussian-copula correlation and need not equal the Pearson correlation of
the observed discrete counts [@chang_sample_2017].
