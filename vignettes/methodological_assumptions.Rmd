...
model is, conditionally on the subject effect. The rate-ratio estimand and
Poisson/negative-binomial framework is supported by published count-outcome
equivalence methods [@chang_sample_2017; @zhu_sample_2017].
...
size-parameter convention \(\operatorname{size}=1/\phi\). This is the
standard mean--dispersion parameterization used for planning negative-binomial
rate comparisons.
